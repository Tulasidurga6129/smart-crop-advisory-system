...
MODEL_PATH = "models/best_finetuned_model.keras"


def main():
    print("\n===== STEP 25: FINE-TUNED MODEL EVALUATION =====\n")
    ...
    for rank, (name, precision, recall, f1) in enumerate(
        weakest,
        start=1
    ):
        print(
    ...
    output_path = (
        output_dir / "finetuned_confusion_matrix.csv"
    )
    ...
    print("\nSaved:")
    print(
        "evaluation/finetuned_confusion_matrix.csv"
    )
